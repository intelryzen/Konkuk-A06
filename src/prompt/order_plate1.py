import sys
sys.path.append('C:/Users/7bcf/Desktop/a6-231108')
sys.path.append('C:/Users/7bcf/Desktop/a6-231108/src')
sys.path.append('C:/Users/7bcf/Desktop/a6-231108/src/model')
...
foodList = [
    Food(1, 1, '후라이드', 16000, {1: 1, 2: 1, 3: 1}),
    Food(2, 1, '양념치킨', 17000, {1: 1, 2: 1, 4: 1}),
    Food(3, 1, '반반치킨', 17000, {1: 1, 2: 1, 3: 1, 4: 1}),
    Food(4, 1, '통구이', 17000, {1: 1, 2: 1, 5: 1}),
    Food(5, 1, '간장치킨', 17000, {1: 1, 2: 1, 6: 1}),
    Food(6, 1, '순살치킨', 17000, {1: 1, 2: 1, 3: 1, 4: 1, 5: 1}),
    Food(7, 1, '바베큐통닭', 19000, {1: 1, 2: 1, 3: 1, 4: 1, 5: 1}),
    Food(8, 1, '황금올리브치킨', 19000, {1: 1, 2: 1, 3: 1, 4: 1, 5: 1})
]
...
if __name__ == '__main__':
    ...
    temp_user = User('test', '2021-05-01', [{'point': 3000, 'date': '2021-05-01'}, {'point': 5000, 'date': '2021-05-02'}], [{'price': 1000, 'date': '2021-05-01', 'use': True}, {'price': 1000, 'date': '2021-05-02', 'use': True}])
